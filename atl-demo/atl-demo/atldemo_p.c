...
/* Object interface: IMyClass, ver. 0.0,
   GUID={0x1D8D593F,0xD92F,0x419E,{0x9F,0xF1,0xFA,0x49,0x40,0x3A,0xAD,0x3A}} */
...
int __stdcall _atldemo_IID_Lookup( const IID * pIID, int * pIndex )
{
    ...
    IID_BS_LOOKUP_INITIAL_TEST( _atldemo, 2, 1 )
    IID_BS_LOOKUP_RETURN_RESULT( _atldemo, 2, *pIndex )
