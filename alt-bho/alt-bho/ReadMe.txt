========================================================================
    ACTIVE TEMPLATE LIBRARY : alt-bho Project Overview
========================================================================

AppWizard has created this alt-bho project for you to use as the starting point for
...
altbho.idl
    ...
    This file will be processed by the MIDL compiler to generate:
        C++ interface definitions and GUID declarations (altbho.h)
        GUID definitions                                (altbho_i.c)
        A type library                                  (altbho.tlb)
        Marshaling code                                 (altbho_p.c and dlldata.c)

altbho.h
    This file contains the C++ interface definitions and GUID declarations of the
    items defined in altbho.idl. It will be regenerated by MIDL during compilation.
...
StdAfx.h, StdAfx.cpp
    ...
    named alt-bho.pch and a precompiled types file named StdAfx.obj.
...
alt-bhops.vcproj
	...
	dlldata.c, altbho_i.c and altbho_p.c which are required
