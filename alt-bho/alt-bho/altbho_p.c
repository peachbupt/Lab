...
typedef struct _altbho_MIDL_TYPE_FORMAT_STRING
    {
    short          Pad;
    unsigned char  Format[ TYPE_FORMAT_STRING_SIZE ];
    } altbho_MIDL_TYPE_FORMAT_STRING;

typedef struct _altbho_MIDL_PROC_FORMAT_STRING
    {
    short          Pad;
    unsigned char  Format[ PROC_FORMAT_STRING_SIZE ];
    } altbho_MIDL_PROC_FORMAT_STRING;

typedef struct _altbho_MIDL_EXPR_FORMAT_STRING
    {
    long          Pad;
    unsigned char  Format[ EXPR_FORMAT_STRING_SIZE ];
    } altbho_MIDL_EXPR_FORMAT_STRING;
...
extern const altbho_MIDL_TYPE_FORMAT_STRING altbho__MIDL_TypeFormatString;
extern const altbho_MIDL_PROC_FORMAT_STRING altbho__MIDL_ProcFormatString;
extern const altbho_MIDL_EXPR_FORMAT_STRING altbho__MIDL_ExprFormatString;
...
extern const MIDL_SERVER_INFO IEyEonIE_ServerInfo;
extern const MIDL_STUBLESS_PROXY_INFO IEyEonIE_ProxyInfo;
...
static const altbho_MIDL_PROC_FORMAT_STRING altbho__MIDL_ProcFormatString =
    {
        0,
        {
...
static const altbho_MIDL_TYPE_FORMAT_STRING altbho__MIDL_TypeFormatString =
    {
        0,
        {
			NdrFcShort( 0x0 ),	/* 0 */
...
static const MIDL_STUBLESS_PROXY_INFO IComponentRegistrar_ProxyInfo =
    {
    &Object_StubDesc,
    altbho__MIDL_ProcFormatString.Format,
...
/* Object interface: IEyEonIE, ver. 0.0,
   GUID={0xE0F5ECFC,0x9244,0x4B3E,{0x9E,0x90,0xC3,0x0F,0xF2,0x8F,0xA9,0x43}} */

#pragma code_seg(".orpc")
static const unsigned short IEyEonIE_FormatStringOffsetTable[] =
    {
    (unsigned short) -1,
    (unsigned short) -1,
    (unsigned short) -1,
...
static const MIDL_STUBLESS_PROXY_INFO IEyEonIE_ProxyInfo =
    {
    &Object_StubDesc,
    altbho__MIDL_ProcFormatString.Format,
    &IEyEonIE_FormatStringOffsetTable[-3],
    0,
    0,
    0
    };
...
static const MIDL_SERVER_INFO IEyEonIE_ServerInfo = 
    {
    &Object_StubDesc,
    0,
    altbho__MIDL_ProcFormatString.Format,
    ...
    0,
    0};
CINTERFACE_PROXY_VTABLE(7) _IEyEonIEProxyVtbl = 
{
    0,
    &IID_IEyEonIE,
    IUnknown_QueryInterface_Proxy,
...
static const PRPC_STUB_FUNCTION IEyEonIE_table[] =
{
    STUB_FORWARDING_FUNCTION,
    STUB_FORWARDING_FUNCTION,
    STUB_FORWARDING_FUNCTION,
...
CInterfaceStubVtbl _IEyEonIEStubVtbl =
{
    &IID_IEyEonIE,
    &IEyEonIE_ServerInfo,
    7,
...
static const MIDL_STUB_DESC Object_StubDesc = 
    ...
    0,
    0,
    altbho__MIDL_TypeFormatString.Format,
...
const CInterfaceProxyVtbl * _altbho_ProxyVtblList[] = 
{
    ( CInterfaceProxyVtbl *) &_IComponentRegistrarProxyVtbl,
    ( CInterfaceProxyVtbl *) &_IEyEonIEProxyVtbl,
    0
};

const CInterfaceStubVtbl * _altbho_StubVtblList[] = 
{
    ( CInterfaceStubVtbl *) &_IComponentRegistrarStubVtbl,
    ( CInterfaceStubVtbl *) &_IEyEonIEStubVtbl,
    0
...
PCInterfaceName const _altbho_InterfaceNamesList[] = 
{
    "IComponentRegistrar",
    "IEyEonIE",
    0
...
#define _altbho_CHECK_IID(n)	IID_GENERIC_CHECK_IID( _altbho, pIID, n)

int __stdcall _altbho_IID_Lookup( const IID * pIID, int * pIndex )
{
    IID_BS_LOOKUP_SETUP

    IID_BS_LOOKUP_INITIAL_TEST( _altbho, 2, 1 )
    IID_BS_LOOKUP_RETURN_RESULT( _altbho, 2, *pIndex )
    
}

const ExtendedProxyFileInfo altbho_ProxyFileInfo = 
{
    (PCInterfaceProxyVtblList *) & _altbho_ProxyVtblList,
    (PCInterfaceStubVtblList *) & _altbho_StubVtblList,
    (const PCInterfaceName * ) & _altbho_InterfaceNamesList,
    (const IID ** ) & _altbho_BaseIIDList,
    & _altbho_IID_Lookup, 
    2,
    2,
