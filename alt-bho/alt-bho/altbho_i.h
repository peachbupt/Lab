...
#ifndef __altbho_i_h__
#define __altbho_i_h__
...
#ifndef __IEyEonIE_FWD_DEFINED__
#define __IEyEonIE_FWD_DEFINED__
typedef interface IEyEonIE IEyEonIE;
#endif 	/* __IEyEonIE_FWD_DEFINED__ */
...
#ifndef __EyEonIE_FWD_DEFINED__
#define __EyEonIE_FWD_DEFINED__

#ifdef __cplusplus
typedef class EyEonIE EyEonIE;
#else
typedef struct EyEonIE EyEonIE;
#endif /* __cplusplus */

#endif 	/* __EyEonIE_FWD_DEFINED__ */
...
#ifndef __IEyEonIE_INTERFACE_DEFINED__
#define __IEyEonIE_INTERFACE_DEFINED__

/* interface IEyEonIE */
/* [unique][helpstring][nonextensible][dual][uuid][object] */ 


EXTERN_C const IID IID_IEyEonIE;

#if defined(__cplusplus) && !defined(CINTERFACE)
    
    MIDL_INTERFACE("E0F5ECFC-9244-4B3E-9E90-C30FF28FA943")
    IEyEonIE : public IDispatch
    {
    public:
    };
    ...
    interface IEyEonIE
    {
        CONST_VTBL struct IEyEonIEVtbl *lpVtbl;
    };
...
#define IEyEonIE_QueryInterface(This,riid,ppvObject)	\
    ( (This)->lpVtbl -> QueryInterface(This,riid,ppvObject) ) 

#define IEyEonIE_AddRef(This)	\
    ( (This)->lpVtbl -> AddRef(This) ) 

#define IEyEonIE_Release(This)	\
    ( (This)->lpVtbl -> Release(This) ) 


#define IEyEonIE_GetTypeInfoCount(This,pctinfo)	\
    ( (This)->lpVtbl -> GetTypeInfoCount(This,pctinfo) ) 

#define IEyEonIE_GetTypeInfo(This,iTInfo,lcid,ppTInfo)	\
    ( (This)->lpVtbl -> GetTypeInfo(This,iTInfo,lcid,ppTInfo) ) 

#define IEyEonIE_GetIDsOfNames(This,riid,rgszNames,cNames,lcid,rgDispId)	\
    ( (This)->lpVtbl -> GetIDsOfNames(This,riid,rgszNames,cNames,lcid,rgDispId) ) 

#define IEyEonIE_Invoke(This,dispIdMember,riid,lcid,wFlags,pDispParams,pVarResult,pExcepInfo,puArgErr)	\
    ( (This)->lpVtbl -> Invoke(This,dispIdMember,riid,lcid,wFlags,pDispParams,pVarResult,pExcepInfo,puArgErr) ) 
...
#endif 	/* __IEyEonIE_INTERFACE_DEFINED__ */



#ifndef __altbhoLib_LIBRARY_DEFINED__
#define __altbhoLib_LIBRARY_DEFINED__

/* library altbhoLib */
/* [custom][helpstring][version][uuid] */ 


EXTERN_C const IID LIBID_altbhoLib;

EXTERN_C const CLSID CLSID_CompReg;

#ifdef __cplusplus

class DECLSPEC_UUID("3BA845B4-D8A8-4186-AFEF-06E0A59FFA03")
CompReg;
#endif

EXTERN_C const CLSID CLSID_EyEonIE;

#ifdef __cplusplus

class DECLSPEC_UUID("65778286-C644-4543-B983-B265AB446A65")
EyEonIE;
#endif
#endif /* __altbhoLib_LIBRARY_DEFINED__ */
